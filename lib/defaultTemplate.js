...
export const INITIAL_SECTIONS = [
  ...
  },
  {
    ...
    content: {
      ...
      subtitle: "Craftly empowers you to design, edit, drag & drop, and deploy modern React web applications with zero friction.",
  ...
  },
  {
    ...
    name: "Modern Footer",
    content: {
      brandName: "Craftly Studio",
      tagline: "Empowering creators to build high-conversion websites.",
      copyright: "© 2026 Craftly. All rights reserved.",
...
<head>
  ...
  <title>Craftly Live Website</title>
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-indigo-500 selection:text-white">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/80 border-b border-slate-800/80 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold shadow-lg">C</div>
            <span className="font-extrabold text-lg text-white tracking-tight">Craftly</span>
      ...
      <header className="max-w-7xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="max-w-2xl mx-auto text-slate-400 text-base sm:text-lg mb-10 leading-relaxed">
          Craftly empowers you to design, edit, drag & drop, and deploy modern React web applications with zero friction.
        </p>
      ...
      <footer className="border-t border-slate-800 bg-slate-950 px-6 py-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <span className="font-bold text-lg text-white">Craftly Studio</span>
          <p className="text-xs text-slate-500">&copy; 2026 Craftly. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
...
export function createSectionsFromPrompt(prompt = "", brandTitle = "Craftly Studio") {
  ...
  const brand = brandTitle || (isEcom ? "Apex Store" : isCrypto ? "Nexus Crypto" : isFood ? "Gourmet Bistro" : isPortfolio ? "Developer Portfolio" : "Craftly Studio");
