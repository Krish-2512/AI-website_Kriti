 ...
 */
export async function downloadProjectZip(files, projectTitle = "craftly-project") {
  const zip = new JSZip();
...
export default function App() {
  return (
    <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center">
      <h1 className="text-3xl font-bold">Hello from Craftly</h1>
    </div>
  );
}
`;
...
Generated with **Craftly AI Design Studio** (Powered by Multiple ML Pipelines & DevOps Automation).
